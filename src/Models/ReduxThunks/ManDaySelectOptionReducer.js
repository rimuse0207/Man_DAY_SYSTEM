...
export const SELECT_OPTIONS_FETCH_DATA_REQUEST =
  "SELECT_OPTIONS_FETCH_DATA_REQUEST";
export const SELECT_OPTIONS_FETCH_DATA_SUCCESS =
  "SELECT_OPTIONS_FETCH_DATA_SUCCESS";
export const SELECT_OPTIONS_FETCH_DATA_FAILURE =
  "SELECT_OPTIONS_FETCH_DATA_FAILURE";

export const Select_Options_fetchDataRequest = () => ({
  type: SELECT_OPTIONS_FETCH_DATA_REQUEST,
});
export const Select_Options_fetchDataSuccess = (data) => ({
  type: SELECT_OPTIONS_FETCH_DATA_SUCCESS,
  payload: data,
});
export const Select_Options_fetchDataFailure = (error) => ({
  type: SELECT_OPTIONS_FETCH_DATA_FAILURE,
  payload: error,
});
  ...
  return async (dispatch) => {
    ...
    try {
      const response = await Request_Get_Axios(
        "/ManDayInfo/Getting_Option_Select_Lists"
      ); // Axios API 호출

      if (response.status)
        dispatch(
          Select_Options_fetchDataSuccess(response.data)
        ); // 성공 시 데이터 저장
