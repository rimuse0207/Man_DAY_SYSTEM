...
const HolidayMainPage = () => {
    ...
    const Handle_Getting_Holiday_Lists_From_Public_open_API_Can_use_1000times_for_one_month = async () => {
        const Handle_Getting_Holiday_Lists_From_Public_open_API_Can_use_1000times_for_one_month_Axios = await Request_Get_Axios(
            '/API/PLM/user/Getting_Holiday_Lists_From_Public_open_API_Can_use_1000times_for_one_month',
            {
                Select_Date,
            }
        );
        if (Handle_Getting_Holiday_Lists_From_Public_open_API_Can_use_1000times_for_one_month_Axios.status) {
            if (Handle_Getting_Holiday_Lists_From_Public_open_API_Can_use_1000times_for_one_month_Axios.data.dataChecking) {
                //성공
    ...
    return (
        <HolidayMainPageMainDivBox>
            <div style={{ borderBottom: '1px solid lightgray', paddingBottom: '10px' }}>
                <h2>공휴일 관리</h2>
                <div style={{ fontSize: '0.8em', marginTop: '10px', color: 'gray' }}>공휴일을 최신 현황으로 갱신 할 수 있습니다.</div>
            </div>
            <div>
                <DepartmentMainPageMainDivBox>
                    ...
                    >
                        <div
                            ...
                            onClick={() => {
                                setSelect_Date(moment(Select_Date).subtract(1, 'year').format('YYYY'));
                            }}
                        >
                        ...
                        <div
                            ...
                            onClick={() => {
                                setSelect_Date(moment(Select_Date).add(1, 'year').format('YYYY'));
                            }}
                        >
                            <MdArrowForwardIos />
                        </div>
                    ...
                    <div className="All_Container">
                        <div className="Left_Content" style={{ width: '50%', height: 'calc(100vh - 250px)', borderLeft: 'none' }}>
                            <UserInfoMainDivBox>
