...
const SalaryMainPage = ({ menuCode }) => {
    ...
    return (
        <PersonMainPageMainDivBox>
            <CommonFilters menuCode={menuCode} Getting_Person_Bar_State={() => Getting_Equipment_Salary_Bar_State()}></CommonFilters>
            ...
            <div>
                ...
                <BarGraph keys={'salary'} Bar_State={Bar_State}></BarGraph>
            </div>
