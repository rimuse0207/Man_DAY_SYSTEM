...
import UserSelectTable from '../../../../../../../User/Department/Contents/Modal/UserSelectTable';
        ...
        <Overlay>
            <Modal>
                <UserModalMainDivBox>
                    ...
                    <div></div>
                    <div className="All_Container" style={{ display: 'flex', height: 'calc(90vh - 100px)' }}>
                        <div
                            className="Left_Content"
                            style={{ height: 'calc(100vh-100px)', width: '30%', borderRight: '1px solid lightgray', overflow: 'auto' }}
                        >
                            <ParentTree
                        ...
                        <div className="Right_Content" style={{ height: 'calc(100vh-100px)', width: '70%' }}>
                            <PersonTableLists onClose={() => onClose()} NowSelect={NowSelect}></PersonTableLists>
                        </div>
                    </div>
                </UserModalMainDivBox>
            </Modal>
