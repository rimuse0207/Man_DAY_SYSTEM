...
const StatisticMainPage = () => {
    const [Menu_Lists, setMenu_Lists] = useState([
        ...
        { menuName: '장비 공수정보', menuCode: 'Equipments', Component: <EquipmentsMainPage menuCode="Equipments" /> },
        { menuName: '장비 인건비', menuCode: 'Salary', Component: <SalaryMainPage menuCode="Salary"></SalaryMainPage> },
        { menuName: '팀,파트', menuCode: 'Team', Component: <TeamMainPage menuCode="Team" /> },
    ]);
